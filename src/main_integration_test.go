...
func Test_normal_layer(t *testing.T) {
	// test a layer wich trigger is [30, 31] and has a mapping from 32 to 64
	inputEvents := []keyboard.KeyboardEvent{
		mock_keyEvent(30, keyboard.KeyPressed),
		mock_keyEvent(31, keyboard.KeyPressed),
		mock_keyEvent(32, keyboard.KeyPressed),
		mock_keyEvent(32, keyboard.KeyReleased),
		mock_keyEvent(30, keyboard.KeyReleased),
		mock_keyEvent(31, keyboard.KeyReleased),
	}

	espectedOutput := []keyboard.KeyboardEvent{
		mock_keyEvent(64, keyboard.KeyPressed),
		mock_keyEvent(64, keyboard.KeyReleased),
	}
...
// func Test_layer_with_exception(t *testing.T) {
// 	inputEvents := []keyboard.KeyboardEvent{
// 		mock_keyEvent(30, keyboard.KeyPressed),
// 		mock_keyEvent(31, keyboard.KeyPressed),
// 		mock_keyEvent(31, keyboard.KeyReleased),
